Program poprawnie rysuje scene i drony. Mozna dodawac dowolna ilosc dronow do sceny (w miare rozsadku).

Wykonanie w pelni obiektowe.

Czesc danych jest nadal wpisywana \char`\"{}na sztywno\char`\"{} w celach testowych. Finalna wersja bedzie bardziej zautomatyzowana.

Animacja lotu jednego z dronow.

Wybieranie drona do uzycia jeszcze nie zaimplementowane.

Dokumentacja w trakcie tworzenia.\hypertarget{md__r_e_a_d_m_e_autotoc_md1}{}\doxysection{Building}\label{md__r_e_a_d_m_e_autotoc_md1}
